...
public:
    CMainParams()
    {
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1529048324;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 1208560;

        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x00000b97ae4a916b25c985de119295e2d466c3022bba1ebd8ca665e4c315fbf9"));
        assert(genesis.hashMerkleRoot == uint256("0x24674b2f63160a2b10827980da819702a2b97d6471b90fe6bdd4c3a3b9e491de"));
...
public:
    CTestNetParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 100;
        nMinerThreads = 0;
        nTargetTimespan = 3 * 60; // shmn: 3 minutes
        nTargetSpacing = 1 * 60;  // shmn: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
        nMasternodeCountDrift = 4;
        nRewardUpgradeBlock = 51197; 
        nMaxMoneyOut = 43199500 * COIN;

        //! Modify the testnet genesis block so the timestamp is valid for a later start.
        genesis.nTime = 1534912804;
        genesis.nNonce = 3184937;

        hashGenesisBlock = genesis.GetHash();
        //printf("CTestNetParams GenesisHash: %s\n",genesis.GetHash().ToString().c_str());
        assert(hashGenesisBlock == uint256("0x00000f4ef32559a9b8335a118eaa76fbdee517f9f472a644179491c2f04a656e"));

        vFixedSeeds.clear();
        vSeeds.clear();
//        vSeeds.push_back(CDNSSeedData("88.198.192.110", "88.198.192.110"));

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet shmn addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet shmn script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet shmn BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet shmn BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet shmn BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // shmn: 1 day
        nTargetSpacing = 1 * 60;        // shmn: 1 minutes
